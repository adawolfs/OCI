...
Demo sobre OCI para la Hora de Kubernetes, esta demo busca demostrar los aspectos generales de Container Images y Container Runtimes.

## Documentacion y Referencias

- [OCI (Pagina oficial)](https://opencontainers.org/)
...
- [Building a container from scratch in Go (Youtube)](https://youtu.be/Utf-A4rODH8)
- [Cgroups, namespaces, and beyond: what are containers made from? (Youtube)](https://youtu.be/sK5i-N34im8)
- [Look inside OCI images and runc (Youtube)](https://youtu.be/xKRcM_Rmwrk)
...
[Slides](https://docs.google.com/presentation/d/1u_I-SZ8KhZ6PEhjCILzBVG5oml44teLB5qmQjv0IY3w/edit?usp=sharing)
